<template>
  <div class="header">
      <router-link @click="scrollToTop()" to="/" class="logo"><img style="width: 60px;" src="../assets/images/hoa-icon.jpg" alt="" />T-Flower
      </router-link>
      ...
      <div class="icons">
          ...
          <div v-if="!user" class="fas fa-user account" @click="showLog">
              <ul class="drop-down-select">
                  <li>
                      <router-link @click="scrollToTop()" to="/login">Đăng nhập</router-link>
                  </li>
                  <li>
                      <router-link @click="scrollToTop()" to="/register">Đăng ký</router-link>
                  </li>
              </ul>
          ...
          <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
              <ul class="drop-down-select" >
                  <li>
                      <router-link @click="scrollToTop()" to="/myorder">đơn hàng</router-link>
                  </li>
                  <li>
                      <router-link @click="handleLogout" to="/">Đăng xuất</router-link>
                  </li>
              </ul>
          </div>
